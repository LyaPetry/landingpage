  ...
  return (
    <div className='w-11/12 mx-auto'>
      <div>
        ...
        <div className='flex py-1 md:py-4'>
          <div style={{ backgroundColor: '#372667' }} className='hidden md:flex  ml-2 my-auto rounded-full h-2 md:h-4 w-2 md:w-4 items-center justify-center'>
          </div>
        ...
        <div className='flex py-1 md:py-4'>
          <div style={{ backgroundColor: '#372667' }} className='hidden md:flex ml-2 my-auto rounded-full h-2 md:h-4 w-3 md:w-4 items-center justify-center'>
          </div>
          <div className='ml-2 my-2'>
