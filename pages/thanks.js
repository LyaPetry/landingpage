  ...
  return (
    <div>
      ...
      <div className={styles.content}>
        ...
        <h2 className='text-center hidden md:block text-2xl md:text-4xl md:text-center px-8 py-6 md:py-14 leading-8'>Vamos ao trabalho <strong>transfor custos em lucros</strong>!</h2>
